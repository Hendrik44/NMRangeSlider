...
//! Project version number for NMRangeSlider.
FOUNDATION_EXPORT double NMRangeSliderVersionNumber;

//! Project version string for NMRangeSlider.
FOUNDATION_EXPORT const unsigned char NMRangeSliderVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <NMRangeSlider/PublicHeader.h>
